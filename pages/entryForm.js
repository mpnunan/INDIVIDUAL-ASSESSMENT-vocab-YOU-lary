...
const entryForm = () => {
  const formString = `
        <form id="entry-form">
          <input type="text" class="create-update-entries form-control" id="input-name" placeholder="Word(s)" required />
          <input type="text" class="create-update-entries form-control" id="input-definition" placeholder="Definition" required />
          <input type="text" class="create-update-entries form-control" id="input-langOrTech" placeholder="Language/ Technology" required /> 
